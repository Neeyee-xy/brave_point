...
class ClientController extends Controller
{
    ...
    {
       return view('pages.admin.users.clients.index')->with(['page_title'=>'Client']);;
    }
    public function tables(Request $request)
    {
       return view('pages.admin.users.clients.tables');;
    }
    public function edit(Request $request)
    {
        $user=User::find($request->id);
       return view('pages.admin.users.clients.edit',compact('user'))->with(['page_title'=>'Client']);;
    }
