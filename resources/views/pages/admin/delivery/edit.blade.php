    ...
    <section class="content">
      <div class="container-fluid">
              ...
              <form id="delivery_form" name="delivery_form">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Delivery Name</label>
                    <input type="text" class="form-control" id="location" name="location" placeholder="Enter location" value="{{$delivery->location}}">
                    <input type="text" class="form-control" id="id" name="id" placeholder="Enter name" value="{{$delivery->id}}" hidden>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Delivery Price</label>
                    <input type="number" class="form-control" id="price" name="price" placeholder="Enter Price" value="{{$delivery->price}}" >
        ...
        <div class="row">
          <div class="card card-primary w-100">
              <div class="card-header">
                <h3 class="card-title">Delivery Data Fee</h3>
              </div>
...
Swal.fire({
  title: "Are you sure?",
  text: "Your are about to delete this delivery ",
  icon: "warning",
     ...
     $("#add_delivery").prop("disabled",true);
        e.preventDefault();
         var formData = new FormData(this);
          ...
          $.ajax({
          url: "/admin/delivery/edit/{{$delivery->id}}",
          type: "post",
          data:  formData,
          contentType: false,
          cache: false,
