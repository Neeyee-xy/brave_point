...
echo '<td><div class="btn-group">
                    ...
                    <div class="dropdown-menu" role="menu" style="">
                      ...
                      <a class="dropdown-item edit_user" href="/admin/users/admins/edit/'.$user->id.'" user_id=""><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="currentColor" fill-rule="evenodd" d="M5 20h14a1 1 0 0 1 0 2H5a1 1 0 0 1 0-2m-1-5L14 5l3 3L7 18H4zM15 4l2-2l3 3l-2.001 2.001z"/></svg> Edit</a>
                    </div>
                  </div></td>';
