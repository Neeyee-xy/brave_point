              ...
              <form id="product_form" name="product_form">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="title" name="title" placeholder="Enter name" value="{{$blog->title}}">
                    <input type="text" class="form-control" id="user_id" name="user_id" placeholder="Enter name" value="{{Auth::user()->id}}" hidden>
                    <input type="text" class="form-control" id="id" name="id" placeholder="Enter name" value="{{$blog->id}}" hidden>
                  </div>
                </div>
                  <div class="col-12 col-sm-12 col-md-12">
                  <div class="form-group">
                ...
                {{htmlspecialchars_decode($blog->post)}}
              </textarea>
                  </div>
                </div>
