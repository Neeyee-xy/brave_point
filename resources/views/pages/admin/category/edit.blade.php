              ...
              <form id="category_form" name="category_form">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="id" name="id" placeholder="Enter name" value="{{$category->id}}" hidden>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Category Icon</label>
                    <input type="text" class="form-control" id="icon" name="icon" placeholder="Enter Icon" value="{{$category->icon}}" >
