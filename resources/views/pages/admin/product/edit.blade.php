              ...
              <form id="product_form" name="product_form">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="id" name="id" placeholder="Enter name" value="{{$product->id}}" hidden>
                  </div>
                </div>
                  <div class="col-12 col-sm-12 col-md-6">
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="carton_price" name="carton_price" placeholder="Enter carton price"value="{{$product->carton_price}}">
                  </div>
                </div>
                  <div class="col-12 col-sm-12 col-md-6">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Product Sachet Price</label>
                    <input type="number" class="form-control" id="sachet_price" name="sachet_price" placeholder="Enter sachet price" value="{{$product->sachet_price}}">
                  </div>
                </div>
                  <div class="col-12 col-sm-12 col-md-6">
                  <div class="form-group">
                  ...
                  <img src="{{$product->image}}" height="200" width="160">
                </div>
                  <div class="col-12 col-sm-12 col-md-6">
                  <div class="form-group">
                ...
                <div class="col-12 col-sm-12 col-md-6">
                  <div class="form-group">
                   ...
                   <textarea class="form-control" id="tips" name="tips">{{$product->tips}}</textarea>
