        ...
        <div class="row">
          <div class="col-12 col-sm-12 col-md-6">
            ...
            <input type="email" name="email" class="form-control add_font_league_spartan mt-2" placeholder="Email Address" value="{{Auth::user()->email}}" readonly >
             ...
             <input type="Text" name="address" class="form-control add_font_league_spartan mt-2" placeholder="Address" value="{{Auth::user()->address}}">

             <select class="form-control add_font_league_spartan mt-2" id="country" name="country">
              ...
              <div class="row mt-2">
              <div class="col-12 col-sm-12 col-md-6">
                  <select class="form-control add_font_league_spartan mt-2" id="city" name="city">
               <option value=""> City</option>
               @foreach($deliveris as $delivery)
               <option value="{{$delivery->id}}" price="{{$delivery->price}}"> {{$delivery->location}}</option>
               @endforeach
               
             </select>
              </div>
              <div class="col-12 col-sm-12 col-md-6">
                 <input type="text" name="postal_code" class="form-control add_font_league_spartan mt-2" placeholder="Postal Code" value="{{Auth::user()->postal_code}}">
            ...
            <!--  <div class="w-100">
             ...
             <button type="submit" class="btn btn-primary btn_primary low_radius w-100 mt-4" id="pay_now">Pay Now</button>
...
?>
          ...
          <div class="w-100 d-flex justify-content-between mt-4">
                  <p>Subtotal</p>
                  @if(isset($prices))
                  <p class="price_label" id="price" price="{{array_sum($prices)}}">NGN {{number_format(array_sum($prices),2)}}</p>
                  @endif
                  
                </div>
                <div class="w-100 d-flex justify-content-between">
                  <p>Delivery</p>
                  <p class="delivery_price">NGN 0</p>
                  
                </div>
                <div class="w-100 d-flex justify-content-between">
                  <p class="font-weight-bold">Total</p>
                  <p class="font-weight-bold total">NGN 0</p>
       ...
       <div style="height: 300px;">
        ...
        <script type="text/javascript">
          ...
          $('#city').val('').trigger('change');
           setTimeout(function() {
             $('#city').val('{{Auth::user()->city}}').trigger('change');
           }, 1000);
           ...
           $(document).on("change","#city", function(e){
            ...
            $('.delivery_price').html("Recalculating...")
            
            var item=$('#price').attr('price');
            item=item.replace('NGN ',"");
            var selectedOption = $(this).find('option:selected');
            var attributeValue = selectedOption.attr('price');
