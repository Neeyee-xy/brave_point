    ...
    <div class="right_sign_box w_50_100 cart_page">
        ...
        <div class="w-100">
              ...
              <div class="input-group mb-2 mr-sm-2">
                ...
                <input type="text" class="form-control google_login" id="inlineFormInputGroupUsername2" style="border-left: 0px !important;" placeholder="Enter Full Name">
              </div>
              <div class="input-group mb-2 mr-sm-2">
                <div class="input-group-prepend ">
                  <div class="input-group-text google_login">
        ...
        <div class="w-100">
             <button type="button" class="btn btn-primary btn_primary low_radius w-100 mt-4">Create Account</button>
