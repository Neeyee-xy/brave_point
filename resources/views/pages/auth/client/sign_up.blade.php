...
@section('title') {{ 'Client Sign Up' }} @endsection
...
<div class="w-100 d_flex_grid">
    ...
    <div class="right_sign_box w_50_100 cart_page">
        ...
        <div class="w-100">
             <button type="button" class="btn btn-primary btn_primary low_radius w-100 mt-4" id="create_client_account">Create Account</button>
